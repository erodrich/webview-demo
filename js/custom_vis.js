...
vis.Network.prototype.animateTraffic = function (edgesTrafficList, onPreAnimationHandler, onPreAnimateFrameHandler, onPostAnimateFrameHandler, onPostAnimationHandler) {
    ...
    var trafficAnimator = {
        ...
        getNetworkTrafficCanvas: function () {
            ...
            if (this.trafficCanvas == undefined) {
                ...
                //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ô¼ï¿½ï¿½ÓµÄ£ï¿½ï¿½Þ¸Äµï¿½bug
        ...
        animateFrame: function (offset, frameCounter) {
            ...
            setTimeout(this.animateFrame.bind(this), 50, offset + .01, frameCounter++);
        },
        //////////////////////////////////////////////////////////////
        //
    ...
    if (trafficAnimator.onPreAnimation
        ...
        return;
    //donde inicia el trafico en relacion con el nodo 
    trafficAnimator.animateFrame(0.1 /*animationStartOffset*/, 25 /*frame*/);
